  ...
  return (
    <div className = 'w-full'>
      <div className = 'overflow-hidden flex flex-col justify-center mt-10 max-w-md mx-auto bg-white shadow-2xl rounded-lg p-9'>
        <div className=''>
          <img className='w-32 mx-auto shadow-xl rounded-full drop-shadow-xl' src={profile} alt='profile'></img>
        </div>
        <div className='text-center mt-5'>
          ...
          <div className='flex align-center justify-center mt-4'>
            ...
            <SocialMediaIcon icon={<FaTwitter color='#00a0dc'/>} name='Twitter' link='https://twitter.com/gullyleoo1'/>
...
const SocialMediaIcon = ({ icon, name, link }) => (
  <a className='text-2xl m-12 p-12 sm:m-2 sm:p-2 transform hover:scale-150 transition-all' href={link}> 
      {icon}
